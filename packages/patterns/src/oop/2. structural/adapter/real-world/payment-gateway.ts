...
class PaymentGatewayAdapter implements IPaymentProcessor {
...
class AnotherPaymentGatewayAdapter implements IPaymentProcessor {
  private anotherGateway: AnotherPaymentGateway;

  constructor(anotherGateway: AnotherPaymentGateway) {
