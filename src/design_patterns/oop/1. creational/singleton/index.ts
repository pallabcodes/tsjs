...
class PrinterService {
    ...
    private mode: string = "Mono"; // default mode
    ...
    public static getInstance(mode: string = "Mono"): PrinterService {
    ...
    public static async getInstanceAsync(mode: string = "Mono"): Promise<PrinterService> {
        if (!PrinterService.instance) {
