...
class Car {
    constructor(public engine: string, public wheels: string, public color: string, public seats: number) {
    }
}
...
class LuxuryCarBuilder implements CarBuilder {
    ...
    private wheels: string = "18 inch Alloy";
    private color: string = "Black";
    private seats: number = 5;
