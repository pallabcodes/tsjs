...
// Demonstration of the Observer pattern usage
...
// Use the Observer pattern when you have one object (the Subject) that needs to notify multiple objects (Observers) about changes in its state.
