Don't need to take anything from here literaly, this is for knowledge/reference -> HOWEVER, THIS SHOULD GIVE CLARITY THAT EVEN SHOULD WE HAVE CURRENT NICE STRTUCUTURE (FOLDER/WORKSPACE) THIS IS NEXT STEP
