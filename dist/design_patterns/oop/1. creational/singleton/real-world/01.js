...
async function createDatabaseService() {
    ...
    return new DatabaseService(async (query) => dbConnection.queryDatabase(query), async () => dbConnection.closeConnection());
}
// ==========================
// Consumer Code
// ==========================
...
const mockDatabaseService = new DatabaseService(async (query) => `Mocked query execution for: ${query}`, async () => 'Mocked connection closed');
// Test code:
(async () => {
