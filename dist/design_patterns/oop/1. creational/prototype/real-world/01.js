...
class Enemy {
    constructor(type, health, attack, armor) {
        this.type = type;
        this.health = health;
        this.attack = attack;
        this.armor = armor;
...
const clonedWarrior = prototypeManager.clonePrototype('warrior');
clonedWarrior.attack = 30; // Modifying the clone's attributes
const clonedGoblin = prototypeManager.clonePrototype('goblin');
clonedGoblin.health = 60; // Customizing the clone's attributes
const clonedSword = prototypeManager.clonePrototype('sword');
