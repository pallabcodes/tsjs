...
class DisplayElement {
    ...
    display() {
        if (!this.data)
            return;
        console.log(`${this.id} - Temperature: ${this.data.temperature}°C, Humidity: ${this.data.humidity}%, Pressure: ${this.data.pressure} hPa`);
    }
}
class AlertSystem {
...
class WeatherStation {
    constructor() {
        ...
        this.observerPriorities = new Map();
    }
    ...
    async setWeatherData(temperature, humidity, pressure) {
